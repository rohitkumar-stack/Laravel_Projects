...
@section('title', 'Group Add - Enthucate')
@section('content')
<!--**********************************
	Content body start
***********************************-->
      ...
      @if(session()->has('success'))
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12 col-lg-12">
                <div class="row">
                    <div class="col-xl-12">
                        <form  method="POST" action="{{ url('/superadmin/save-group' ) }}" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Group *</label>
                                                    <input type="text" class="form-control" placeholder="Enter name"  name="group_name" value="{{ old('group_name') }}"/>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
