                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-12">
                            <div class="auth-form">
                                ...
                                @if($role_id == 5)
                                <h4 class="text-center mb-4 text-white">Log In as Principal</h4>
                                @elseif($role_id == 6)
                                <h4 class="text-center mb-4 text-white">Log In as District Official</h4>
                                @elseif($role_id == 7)
                                <h4 class="text-center mb-4 text-white">Log In as H.O.D</h4>
                                 @elseif($role_id == 7)
                                <h4 class="text-center mb-4 text-white">Log In as Staff</h4>
                                @endif
