    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ url('superadmin/profile') }}" class="dropdown-item ai-icon">
        ...
        @include('includes.superadmin_sidebar')
        @yield('content')
        @include('includes.admin_footer')
        <script src="{{ asset('public/assets/js/custom/superadmin_developer.js') }}"></script>
         @yield('page_script')
