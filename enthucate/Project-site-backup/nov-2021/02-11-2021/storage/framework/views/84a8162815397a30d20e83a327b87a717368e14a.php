...
<div class="modal fade" id="deleteclass" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         ...
         <form class="form" method="POST" id="classdelete" action="<?php echo e(url(Auth::User()->organisation_url.'/admin/delete-class/')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/enthucate/resources/views/admin/class/class.blade.php ENDPATH**/ ?>