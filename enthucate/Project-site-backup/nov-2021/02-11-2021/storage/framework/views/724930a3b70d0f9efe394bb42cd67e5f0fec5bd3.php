...
<script>
    ...
    $(document).on('click','.searchgrade',function(){  
       ...
       window.location.href='<?php echo e(url("/")); ?>/superadmin/message-list?category='+category+'&messagetype='+messagetype;
...
<?php echo $__env->make('layouts.superadmin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/enthucate/resources/views/superadmin/chat.blade.php ENDPATH**/ ?>