...
<head>
    ...
    <?php echo $__env->make('includes.admin_head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?php echo e(URL(Auth::User()->organisation_url.'/admin')); ?>" class="brand-logo">
            <img class="logo-abbr" src="<?php echo e(asset('public/assets/images/logo1.png')); ?>" alt="">
                <img class="brand-title" src="<?php echo e(asset('public/assets/images/logo.png')); ?>" alt="">
        ...
        ***********************************-->
            ...
            <div class="custom-tab-1">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#notes">Departments</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#alerts">Groups</a>
                    </li>
                    <li class="nav-item">
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('public/assets/images/avatar/1.jpg')); ?>" class="rounded-circle user_img" alt=""/>
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('public/assets/images/avatar/2.jpg')); ?>" class="rounded-circle user_img" alt=""/>
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('public/assets/images/avatar/3.jpg')); ?>" class="rounded-circle user_img" alt=""/>
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('public/assets/images/avatar/4.jpg')); ?>" class="rounded-circle user_img" alt=""/>
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('public/assets/images/avatar/5.jpg')); ?>" class="rounded-circle user_img" alt=""/>
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('public/assets/images/avatar/6.jpg')); ?>" class="rounded-circle user_img" alt=""/>
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                            ...
                            <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
                                        <img src="<?php echo e(asset('public/assets/images/avatar/1.jpg')); ?>" class="rounded-circle user_img_msg" alt=""/>
                                    </div>
                                ...
                                <div class="d-flex justify-content-end mb-4">
                                    ...
                                    <div class="img_cont_msg">
                                <img src="<?php echo e(asset('public/assets/images/avatar/2.jpg')); ?>" class="rounded-circle user_img_msg" alt=""/>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
        ...
        ***********************************-->
                           ...
                           <!--  <li class="nav-item dropdown notification_dropdown">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media mr-2">
                                                        <img alt="image" width="50" src="<?php echo e(asset('public/assets/images/avatar/1.jpg')); ?>">
                                                    </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                if(auth()->user()->profile_pic != ''){
                                    $avatar = '/images/user_profile/'.auth()->user()->profile_pic;
                                }
                                else{
                                ...
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="<?php echo e(asset($avatar)); ?>" width="20" alt=""/>
                                    <div class="header-info">
                                    <?php $roles = App\Models\RoleType::where(['id' => auth()->user()->role_id])->first();
                                    $organisation = App\Models\Organisation::where(['id' => auth()->user()->organisation_id])->first();
                                        $role = ''; 
                                        if(!empty($roles)){
                                            $role = $roles->role;
                                        }
                                    ...
                                    ?>
                                        <span class="text-black"><?php echo e($organisation->organisation_name); ?></span>
                                        <p class="fs-12 mb-0"><?php echo e($role); ?></p>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?php echo e(URL(Auth::User()->organisation_url.'/admin/profile')); ?>" class="dropdown-item ai-icon">
                                    ...
                                    <a href="<?php echo e(route('logout')); ?>" class="dropdown-item ai-icon" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
        ...
        <script src="<?php echo e(asset('public/assets/js/custom/developer.js')); ?>"></script>
        <?php echo $__env->yieldContent('page_script'); ?>

</body>
</html><?php /**PATH /var/www/sites/enthucate/resources/views/layouts/admin_layout.blade.php ENDPATH**/ ?>