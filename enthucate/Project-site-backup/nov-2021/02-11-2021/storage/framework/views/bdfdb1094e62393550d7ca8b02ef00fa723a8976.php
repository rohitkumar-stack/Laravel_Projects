                                    ...
                                    <div class="custom-tab-1">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade <?php if(old('message_type') != 'group' && old('message_type') != 'school'): ?> show active <?php endif; ?> " id="home1" role="tabpanel">
                                                <div class="pt-4">
                                                     <form method="POST" action="<?php echo e(url(Auth::User()->organisation_url.'/admin/save-message' )); ?>" enctype="multipart/form-data" autocomplete="off">
                                                     <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <!-- <div class="dropdown bootstrap-select show-tick form-control"> -->
                                                                        ...
                                                                        <?php if(!empty($departments)): ?> <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <!-- <div class="dropdown bootstrap-select show-tick form-control"> -->
                                                                        ...
                                                                        <?php if(!empty($groups)): ?> <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <!-- <div class="dropdown bootstrap-select show-tick form-control"> -->
                                                                        ...
                                                                        <?php if(!empty($schools)): ?> <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/enthucate/resources/views/admin/message/addmessage.blade.php ENDPATH**/ ?>