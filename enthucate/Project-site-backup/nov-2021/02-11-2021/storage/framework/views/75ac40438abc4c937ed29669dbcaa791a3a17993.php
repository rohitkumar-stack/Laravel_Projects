                        ...
                        <div class="table-responsive">
                            <div id="example3_wrapper" class="dataTables_wrapper no-footer">                                                              
                                <table id="example3" class="display table-responsive-lg dataTable no-footer organisations_list" role="grid" aria-describedby="example3_info">
                                    ...
                                    <?php
                                        if(!empty($results)){
                                            $org_adds = App\Models\RolesPermissionMeta::where('role_id', Auth::User()->role_id)->where('meta_key','org_delete')->first();
                                            $org_edit = App\Models\RolesPermissionMeta::where('role_id', Auth::User()->role_id)->where('meta_key','org_edit')->first();
                                            ...
                                            if(isset($results['organisations']) && $results['organisations'] != ''){
                                                foreach ($results['organisations'] as $key => $result) { 
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                        <?php if(isset($org_edit->meta_value) && $org_edit->meta_value == 'on'): ?>
                                                            <a href="<?php echo e(url(Auth::User()->organisation_url.'/admin/edit-organisation/'.$result->id )); ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                            <?php endif; ?>
...
<div class="modal fade" id="markdelete" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         ...
         <form class="form" method="POST" id="organisationdelete" action="<?php echo e(url(Auth::User()->organisation_url.'/admin/delete-organisation/')); ?>">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/enthucate/resources/views/admin/organisation/organisation.blade.php ENDPATH**/ ?>