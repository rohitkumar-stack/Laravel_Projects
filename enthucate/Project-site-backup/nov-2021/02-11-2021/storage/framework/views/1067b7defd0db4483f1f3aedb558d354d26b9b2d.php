      ...
      <?php if(session()->has('success')): ?>
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12 col-lg-12">
                <div class="row">
                    <div class="col-xl-12">
                         <form method="POST" action="<?php echo e(url('/superadmin/update-department/'.$department->id )); ?>">
                           <?php echo csrf_field(); ?>
                           <?php
                            $memberid = array();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/enthucate/resources/views/superadmin/department/editdepartment.blade.php ENDPATH**/ ?>