<?php $__env->startSection('title', 'class List - Enthucate'); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-sm-3">
                         ...
                         <div class="col-sm-3 selectgrade">
                            <div class="form-group">
                                ...
                                <table id="example3" class="display table-responsive-lg dataTable no-footer class_list" role="grid" aria-describedby="example3_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" aria-label="Name: activate to sort column ascending">Organisation</th>
...
<div class="modal fade" id="deleteclass" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         ...
         <form class="form" method="POST" id="classdelete" action="<?php echo e(url('/superadmin/delete-class/')); ?>">
            <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    function load_departmentlist(organisation,school,grade){
        ...
        ajax: {
          url : siteurl+"/superadmin/classlist" ,
          type: "get",
          dataType: "json",
          data: function (d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/enthucate/resources/views/superadmin/class/class.blade.php ENDPATH**/ ?>