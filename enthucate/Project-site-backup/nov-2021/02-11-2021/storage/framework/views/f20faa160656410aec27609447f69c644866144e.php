<?php $__env->startSection('title', 'User List - Enthucate'); ?>
                                ...
                                <table id="example3" class="display table-responsive-lg dataTable no-footer user_list" role="grid" aria-describedby="example3_info">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td><?php echo e($roletype->role); ?></td> 
                                            <td style="<?php echo $colors; ?>"><?php echo e($status); ?></td>      
                                            <td><?php echo e($result->email); ?></td>
                                            <td>
                                                <div class="d-flex">
                                                  <!--   <?php echo $checktype; ?> -->
                                                  <?php if(isset($user_edit->meta_value) && $user_edit->meta_value == 'on'): ?>
                                                    <a href="<?php echo e(url(Auth::User()->organisation_url.'/admin/edit-user/'.$result->id )); ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                    <?php endif; ?>
                                                    <?php if(isset($user_add->meta_value) && $user_add->meta_value == 'on'): ?>
                                                    <a href="javascript:void(0)" class="btn btn-danger shadow btn-xs sharp markuserdelete" data-id="<?php echo e($result->id); ?>" data-toggle="modal" data-target="#deleteuser" title="Delete user" data-placement="right" ><i class="fa fa-trash"></i></a>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                            </tr>
...
<div class="modal fade" id="deleteuser" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         ...
         <form class="form" method="POST" id="userdelete" action="<?php echo e(url(Auth::User()->organisation_url.'/admin/delete-user/')); ?>">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/enthucate/resources/views/admin/user/user.blade.php ENDPATH**/ ?>