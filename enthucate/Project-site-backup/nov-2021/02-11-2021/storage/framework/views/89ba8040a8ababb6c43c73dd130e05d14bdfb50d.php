    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                <div class="row">                
                    <div class="col-xl-12">
                         <form method="POST" action="<?php echo e(url('/superadmin/update-organisation/'.$organisations->id )); ?>">
                           <?php echo csrf_field(); ?>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="row">
                                           ...
                                           <!--  <div class="col-sm-4">
                                            ...
                                            <!--  <div class="col-sm-4 Subdivision_main" <?php if($organisations->parent_id != Auth::User()->id): ?> style="display:block; <?php endif; ?>">
                                             <?php if(!empty($suborganisations)): ?>
                                              <div class="form-group">
                                                    <label>Sub division *</label>
                                                    <select class="form-control Subdivisiontype" name="parent_id" >
                                                         <option value="">Select License Type</option>
                                                            <?php $__currentLoopData = $suborganisations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suborganisation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($suborganisation->id); ?>" <?php if($suborganisation->id == $user->organisation_id): ?> selected <?php endif; ?>><?php echo e($suborganisation->organisation_name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                              <?php endif; ?>  
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/enthucate/resources/views/superadmin/organisation/editorganisation.blade.php ENDPATH**/ ?>