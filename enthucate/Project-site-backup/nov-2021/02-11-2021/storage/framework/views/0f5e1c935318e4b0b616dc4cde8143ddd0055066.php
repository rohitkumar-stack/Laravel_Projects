    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    ...
                                    ?>
                                        <span class="text-black"><?php echo auth()->user()->name ; ?></span>
                                        <p class="fs-12 mb-0"><?php echo e($role); ?></p>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?php echo e(url('superadmin/profile')); ?>" class="dropdown-item ai-icon">
        ...
        <?php echo $__env->make('includes.superadmin_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->yieldContent('content'); ?>
        <?php echo $__env->make('includes.admin_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <script src="<?php echo e(asset('public/assets/js/custom/superadmin_developer.js')); ?>"></script>
         <?php echo $__env->yieldContent('page_script'); ?>

</body>
</html><?php /**PATH /var/www/sites/enthucate/resources/views/layouts/superadmin_layout.blade.php ENDPATH**/ ?>