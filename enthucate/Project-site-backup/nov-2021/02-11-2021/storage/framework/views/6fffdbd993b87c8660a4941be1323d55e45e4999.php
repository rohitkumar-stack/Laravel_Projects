...
<div class="modal fade" id="deleteschool" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         ...
         <form class="form" method="POST" id="schooldelete" action="<?php echo e(url('/superadmin/delete-group/')); ?>">
            <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
      ...
      var organisation = '';
      load_grouplist(organisation);
    });
    function load_grouplist(organisation){
        ...
        ajax: {
          url : siteurl+"/superadmin/grouplist" ,
          type: "get",
          dataType: "json",
          data: function (d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/enthucate/resources/views/superadmin/group/group.blade.php ENDPATH**/ ?>