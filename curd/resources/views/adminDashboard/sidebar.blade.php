...
<html lang="en">
   <head>
      ...
      <!-- calendar file css -->
      <link rel="stylesheet" href="/adminDashboard/css/semantic.min.css" />
      <!--[if lt IE 9]>
   ...
   <body class="inner_page widgets">
               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img"><img class="img-responsive" src="/adminDashboard/images/layout_img/user_img.jpg" alt="#" /></div>
                        <div class="user_info">
                           <h6>John David</h6>
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="index.html"><img class="img-responsive" src="/adminDashboard/images/logo/logo.png" alt="#" /></a>
                        </div>
      ...
      <!-- calendar file css -->    
      <script src="/adminDashboard/js/semantic.min.js"></script>
      <script></script>
   </body>
</html>
