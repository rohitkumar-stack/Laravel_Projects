@extends('adminDashboard/sidebar')
@section('content')
                     ...
                     <div class="row column1">
                           ...
                           <div class="full white_shd margin_bottom_30">
                              <div class="info_people">
                                 <div class="p_info_img">
                                    <img src="/adminDashboard/images/layout_img/msg2.png" alt="#" />
                                 </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                           <div class="full white_shd margin_bottom_30">
                              <div class="info_people">
                                 <div class="p_info_img">
                                    <img src="/adminDashboardimages/layout_img/msg3.png" alt="#" />
                                 </div>
                                 <div class="user_info_cont">
                                    <h4>David</h4>
                                    <p>developer@gmail.com</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                           <div class="full white_shd margin_bottom_30">
                              <div class="info_people">
                                 <div class="p_info_img">
                                    <img src="/adminDashboard/images/layout_img/msg4.png" alt="#" />
                                 </div>
                                 <div class="user_info_cont">
                                    <h4>John</h4>
                                    <p>developer@gmail.com</p>
