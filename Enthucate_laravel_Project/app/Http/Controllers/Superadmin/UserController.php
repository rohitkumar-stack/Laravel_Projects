...
class UserController extends Controller
{
   public function __construct()
    ...
    {
        $results = User::where('is_del','0')->where('user_type','=','user')->get();
        $organisations = Organisation::where('is_del','0')->get();
        return view('superadmin.user.user',['results'=>$results,'organisations'=>$organisations]);
    }
    public function UserList(Request $request)
    {
        ...
        if($_REQUEST['organisation'] != ''){
          $order_count= User::where('is_del','0')->where('user_type','=','user')->where('organisation_id',$_REQUEST['organisation']);
          
        }
        else{
          $order_count= User::where('is_del','0')->where('user_type','=','user');
        }
        if($search != ''){
      ...
      $order_count = $order_count->count();
        $result= User::where('is_del','0')->where('user_type','=','user');
        if($_REQUEST['organisation'] != ''){
        ...
        foreach ($result as $key => $order) {
          ...
          $action = '';
           $action = '<div class="d-flex">
            <a href="'.url('/superadmin/edit-user/'.$order->id ).'" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
            <a href="javascript:void(0)" class="btn btn-danger shadow btn-xs sharp markuserdelete" data-id="'.$order->id.'" data-toggle="modal" data-target="#deleteuser" title="Delete user" data-placement="right" ><i class="fa fa-trash"></i></a>
            </div>';
    ...
    public function create()
    {
        ...
        return view('superadmin.user.adduser',['roletypes'=>$roletypes,'hierarchys'=>$hierarchys,'hierarchyLicense'=>$hierarchyLicense,'countries'=>$countries,'organisations'=>$organisations]);
    }
    ...
    public function store(Request $request)
    {
       ...
       // $input['department_id']=$request->department;        
        ...
        return redirect('/superadmin/user-list')->with('success', 'User added successfully!'); 
    ...
    public function edit($id)
    {
        ...
        $countries = Country::get();
        $roletypes = RoleType::where('is_del','0')->get();
        return view('superadmin.user.edituser',['user'=>$user,'schools'=>$schools,'roletypes'=>$roletypes,'departments'=>$departments,'countries'=>$countries]);
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       $validator = \Validator::make($request->all(), [            
        ...
        return redirect('/superadmin/user-list')->with('success', 'User Updated successfully!'); 
    }
    ...
    public function destroy(Request $request)
    {
        ...
        return redirect('/superadmin/user-list')->with('success', 'User Deleted successfully!');
    }
}
