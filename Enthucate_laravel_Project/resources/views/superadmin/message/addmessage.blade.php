@extends('layouts.superadmin_layout') @section('title', 'Message Add - Enthucate') @section('content')
<!--**********************************
    Content body start
***********************************-->
                                    ...
                                    <div class="custom-tab-1">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade @if (old('message_type') != 'group' && old('message_type') != 'school') show active @endif " id="home1" role="tabpanel">
                                                <div class="pt-4">
                                                     <form method="POST" action="{{ url('/superadmin/save-message' ) }}" enctype="multipart/form-data" autocomplete="off">
                                                     @csrf
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control seleorganisation_id" name="organisation" id="seleorganisationid">
                                                                        ...
                                                                        @if(!empty($organisations)) @foreach($organisations as $organisation)
