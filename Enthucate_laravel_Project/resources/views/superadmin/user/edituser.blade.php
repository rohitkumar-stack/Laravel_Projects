    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12 col-xxl-12 col-lg-12">
                ...
                <div class="row">
                    <div class="col-xl-12">
                         <form method="POST" action="{{ url('/superadmin/update-user/'.$user->id ) }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <?php
                            $schoolid = array();
                            if($user->school_id != ''){
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if(!empty($schools))
                                                            @foreach($schools as $school)
                                                                ...
                                                                @if(in_array($school->id, $schoolid)) selected @endif >{{$school->school_name}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
