                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-12">
                            <div class="auth-form">
                                ...
                                <h4 class="text-center mb-4 text-white">Set a new password</h4>
                                <p class="mb-4 text-white" style="text-align: center;">This will change your password</p>
                                <form method="POST" action="{{ url('save-organisation-password') }}">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$user->id}}" />
                                    <input type="hidden" name="type" value="newpassword" />
                                    <input type="hidden" class="form-control" name="email" value="{{ $user->email }}" placeholder="Phone Number" readonly />
