                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-12">
                            <div class="auth-form">
                                ...
                                <h4 class="text-center text-white">Create account for Teacher</h4>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="auth-form">
                                ...
                                <form method="post" action="{{url('create-teacher-account')}}" enctype="multipart/form-data" autocomplete="off">
                                    @csrf
                                    <div class="text-primary title-text mb-4">CLASS INFO</div>
                                    ...
                                    <div class="text-primary title-text mb-4 mt-4">TEACHER INFORMATION</div>
                                    <div class="form-group">
