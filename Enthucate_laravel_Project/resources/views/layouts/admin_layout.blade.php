    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{URL(Auth::User()->organisation_url.'/admin')}}" class="brand-logo">
            <img class="logo-abbr" src="{{ asset('public/assets/images/logo1.png') }}" alt="">
                <img class="brand-title" src="{{ asset('public/assets/images/logo.png') }}" alt="">
                            ...
                            <div class="card-body contacts_body p-0 dz-scroll  " id="DZ_W_Contacts_Body">
                                <ul class="contacts">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('public/assets/images/avatar/2.jpg') }}" class="rounded-circle user_img" alt=""/>
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('public/assets/images/avatar/3.jpg') }}" class="rounded-circle user_img" alt=""/>
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('public/assets/images/avatar/4.jpg') }}" class="rounded-circle user_img" alt=""/>
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('public/assets/images/avatar/5.jpg') }}" class="rounded-circle user_img" alt=""/>
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('public/assets/images/avatar/6.jpg') }}" class="rounded-circle user_img" alt=""/>
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                            ...
                            <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
                                        <img src="{{ asset('public/assets/images/avatar/1.jpg') }}" class="rounded-circle user_img_msg" alt=""/>
                                    </div>
                                ...
                                <div class="d-flex justify-content-end mb-4">
                                    ...
                                    <div class="img_cont_msg">
                                <img src="{{ asset('public/assets/images/avatar/2.jpg') }}" class="rounded-circle user_img_msg" alt=""/>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
        ...
        ***********************************-->
                           ...
                           <!--  <li class="nav-item dropdown notification_dropdown">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media mr-2">
                                                        <img alt="image" width="50" src="{{ asset('public/assets/images/avatar/1.jpg') }}">
                                                    </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{ asset($avatar) }}" width="20" alt=""/>
                                    ...
                                    ?>
                                        <span class="text-black">{{$organisation->organisation_name}}</span>
                                        <p class="fs-12 mb-0">{{$role}}</p>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{URL(Auth::User()->organisation_url.'/admin/profile')}}" class="dropdown-item ai-icon">
        ...
        <script src="{{ asset('public/assets/js/custom/developer.js') }}"></script>
        @yield('page_script')
